...
export const publicKey = new Uint8Array([
  246, 196, 80, 161, 107, 177, 197, 20, 226, 47, 25, 119, 227, 144, 163, 2, 85,
  153, 170, 30, 123, 0, 6, 138, 106, 172, 242, 17, 148, 132, 193, 189,
]);
...
export function createMockApiClient(): ApiClient {
  return {
    ...
    getAccountTransactions: mockFn().mockResolvedValue(
      {} as ToncenterTransactionsResponse,
    ),
    getPendingTrace: mockFn().mockResolvedValue({} as ToncenterTracesResponse),
    getPendingTransactions: mockFn().mockResolvedValue(
      {} as ToncenterTransactionsResponse,
    ),
    getTrace: mockFn().mockResolvedValue({} as ToncenterTracesResponse),
    getTransactionsByHash: mockFn().mockResolvedValue(
      {} as ToncenterTransactionsResponse,
    ),
    ...
    jettonsByAddress: mockFn().mockResolvedValue(
      {} as ToncenterResponseJettonMasters,
    ),
