...
export function toNftItem(data: NftItemV3): NFT {
  const out: NFT = {
    ...
    collection:
      toNftCollection(data.collection_address, data.collection) ?? undefined,
    auctionContractAddress:
      asMaybeAddressFriendly(data.auction_contract_address) ?? undefined,
    ...
    saleContractAddress:
      asMaybeAddressFriendly(data.sale_contract_address) ?? undefined,
