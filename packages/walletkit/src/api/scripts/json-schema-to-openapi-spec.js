...
try {
  ...
  console.error(
    '❌ Could not load @openapi-contrib/json-schema-to-openapi-schema',
  );
  console.error('Error:', e.message);
  console.error(
    'Please install: npm install -g @openapi-contrib/json-schema-to-openapi-schema',
  );
  process.exit(1);
}
...
try {
  ...
  const openapi = {
    ...
    info: {
      ...
      version: '1.0.0',
      description:
        'Auto-generated OpenAPI specification from TypeScript models',
    },
    paths: {},
    components: {
