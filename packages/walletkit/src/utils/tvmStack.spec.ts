...
describe('SerializeStack', () => {
  ...
  it('serializes a negative int', () => {
    const result = SerializeStack([{ type: 'int', value: -10n }]) as Array<{
      type: string;
      value: string;
    }>;
  ...
  it('serializes zero', () => {
    const result = SerializeStack([{ type: 'int', value: 0n }]) as Array<{
      type: string;
      value: string;
    }>;
  ...
  it('serializes a cell', () => {
    ...
    const result = SerializeStack([{ type: 'cell', cell }]) as Array<{
      type: string;
      value: string;
    }>;
  ...
  it('serializes a slice', () => {
    ...
    const result = SerializeStack([{ type: 'slice', cell }]) as Array<{
      type: string;
      value: string;
    }>;
...
describe('round-trip: ParseStack(SerializeStack(items))', () => {
  ...
  it('cell round-trip', () => {
    ...
    const item = parsed[0];
    if (item.type !== 'cell') throw new Error('expected cell');
    expect(item.cell.toBoc().toString('base64')).toBe(
