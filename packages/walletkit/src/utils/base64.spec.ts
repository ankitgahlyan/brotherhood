...
describe('base64', () => {
  it('base64ToHash', async () => {
    ...
    expect(Base64ToHex(data)).toEqual(
      '0x494d1e5c89a3848d5aaba54eeec2e11f6c9c72dd624e0d8a318db1e2ca395986',
    );
  });

  it('uint8ArrayToBase64/base64ToUint8Array', async () => {
    expect(Uint8ArrayToBase64(Base64ToUint8Array(data) as Uint8Array)).toEqual(
      data,
    );
  });
