...
export const DEFAULT_METADATA: Record<string, StakingProviderMetadata> = {
  [Network.mainnet().chainId]: {
    ...
    receiveToken: {
      ...
      decimals: 9,
      address:
        'EQC98_qAmNEptUtPc7W6xdHh_ZHrBUFpw5Ft_IzNU20QAJav' as UserFriendlyAddress,
    },
    contractAddress:
  ...
  [Network.testnet().chainId]: {
    ...
    receiveToken: {
      ...
      decimals: 9,
      address:
        'kQAiQ2XK7BXePLwemeo-u4wNyjg-wxGeySmaFGEP7R2Mhf4m' as UserFriendlyAddress,
    },
    contractAddress:
      'kQANFsYyYn-GSZ4oajUJmboDURZU-udMHf9JxzO4vYM_hFP3' as UserFriendlyAddress,
    supportedUnstakeModes: [
      UnstakeMode.INSTANT,
      UnstakeMode.WHEN_AVAILABLE,
      UnstakeMode.ROUND_END,
