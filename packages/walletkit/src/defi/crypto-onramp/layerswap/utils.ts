...
const BITCOIN_ADDRESS_REGEX =
  '^([13][1-9A-HJ-NP-Za-km-z]{25,34}|bc1[02-9ac-hj-np-z]{6,87})$';
 ...
 */
export const DEFAULT_LAYERSWAP_SUPPORTED_CHAINS: Record<
  string,
  LayerswapChainConfig
> = {
 ...
 */
export const toLayerswapDestinationToken = (symbol: string): string =>
  symbol === 'GRAM' ? 'TON' : symbol;

export const isErrorResponse = (
  body: unknown,
): body is LayerswapErrorResponse => {
  return (
    typeof body === 'object' &&
    body !== null &&
