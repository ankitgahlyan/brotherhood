...
describe('Toncenter Mappers', () => {
  ...
  describe('mapBalance', () => {
    it('should map balance notification correctly', () => {
      ...
      const result = mapBalance(
        notification as unknown as StreamingV2AccountStateNotification,
      );
      ...
      expect(result.address).toBe(
        'EQCD39VS5jcptHL8vMjETmzGaRcCVYto7LUn4bpAOg8xqCPE',
      );
    });
  ...
  describe('mapTransactions', () => {
    ...
    it('should map transactions notification correctly and filter by account', () => {
      ...
      const result = mapTransactions(
        ADDR,
        notification as unknown as StreamingV2TransactionsNotification,
      );
    ...
    it('should map optional addressBook and metadata', () => {
      const notification = {
        ...
        transactions: [],
        address_book: {
          [ADDR]: { user_friendly: ADDR, domain: null, interfaces: [] },
        },
        metadata: { some: 'data' },
        finality: 'confirmed' as const,
      };
  ...
  describe('mapJettons', () => {
    it('should map jettons notification correctly with metadata', () => {
      ...
      const result = mapJettons(
        notification as unknown as StreamingV2JettonsNotification,
      );
