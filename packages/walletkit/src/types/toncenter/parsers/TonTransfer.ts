...
function extractComment(msg: EmulationMessage): string | null {
  type DecodedComment =
    { '@type'?: string; comment?: string; text?: string } | null | undefined;
