...
export class EventRouter {
  ...
  // Event callbacks
  private connectRequestCallback:
    EventCallback<ConnectionRequestEvent> | undefined = undefined;
  private transactionRequestCallback:
    EventCallback<SendTransactionRequestEvent> | undefined = undefined;
  private signDataRequestCallback:
    EventCallback<SignDataRequestEvent> | undefined = undefined;
  private signMessageRequestCallback:
    EventCallback<SignMessageRequestEvent> | undefined = undefined;
  private disconnectCallback: EventCallback<DisconnectionEvent> | undefined =
    undefined;
  private errorCallback: EventCallback<RequestErrorEvent> | undefined =
    undefined;
  ...
  onTransactionRequest(
    callback: EventCallback<SendTransactionRequestEvent>,
  ): void {
   ...
   */
  private async notifyTransactionRequestCallbacks(
   ...
   */
  private async notifySignDataRequestCallbacks(
   ...
   */
  private async notifySignMessageRequestCallbacks(
   ...
   */
  private async notifyDisconnectCallbacks(
