...
class TabletHeaderActionsView(
        ...
        itemViews.forEachIndexed { index, itemView ->
            ...
            if (identifier == HeaderActionsView.Identifier.SEND) {
                itemView.setOnLongClickListener {
                    if (alpha > 0 && (isMultisendAllowed() || isSellAllowed())) {
    ...
    private fun isMultisendAllowed(): Boolean =
        context.getString(BaseR.string.app_multisend_url).isNotEmpty()
