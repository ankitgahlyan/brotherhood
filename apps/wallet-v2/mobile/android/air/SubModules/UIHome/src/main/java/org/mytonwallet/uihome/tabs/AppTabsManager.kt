...
object AppTabsManager {
    ...
    val defaultTabIds = listOf(TAB_WALLET, TAB_SETTINGS)
    ...
    fun isAvailable(tabId: String): Boolean = tabId == TAB_WALLET || tabId == TAB_SETTINGS

    fun isAvailable(tab: AppTab): Boolean = isAvailable(tab.id)
