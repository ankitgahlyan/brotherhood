...
interface WalletContextManagerDelegate {
    fun restartApp()
    fun getAddAccountVC(network: MBlockchainNetwork = WGlobalStorage.getAddWalletNetwork()): Any
    ...
    fun getImportLedgerVC(network: MBlockchainNetwork = WGlobalStorage.getAddWalletNetwork()): Any
    fun getAddViewAccountVC(network: MBlockchainNetwork = WGlobalStorage.getAddWalletNetwork()): Any
