...
object WGlobalStorage {
    ...
    private const val ADD_WALLET_NETWORK = "settings.addWalletNetwork"
    ...
    fun getAddWalletNetwork(): MBlockchainNetwork {
        val raw = globalStorageProvider.getString(ADD_WALLET_NETWORK)
            ?: return MBlockchainNetwork.TESTNET
        return if (raw ==
    ...
    fun setAddWalletNetwork(network: MBlockchainNetwork) {
        globalStorageProvider.set(
            ADD_WALLET_NETWORK,
            network.value,
            IGlobalStorageProvider.PERSIST_INSTANT
