...
import SettingsApiKeysModal from './SettingsApiKeysModal';
...
function Settings({
  ...
  const [isApiKeysModalOpen, openApiKeysModal, closeApiKeysModal] = useFlag();
    ...
    return (
      <div className={styles.slide}>
        ...
        >
          ...
          {IS_PORTFOLIO_ENABLED && isPortfolioAvailable && (
            <div className={styles.block}>
          ...
          <div className={styles.block}>
            ...
            <div className={buildClassName(styles.item, styles.itemMenu)} onClick={openApiKeysModal}>
              <img
                className={styles.menuIcon}
                src={tonProxyImg}
                alt={lang('Network & API Keys') || 'Network & API Keys'}
              />
              <div className={styles.itemContent}>
                <span className={styles.itemTitle}>{lang('Network & API Keys') || 'Network & API Keys'}</span>
                <span className={styles.itemSubtitle}>
                  {isDirectTestnetApi
                    ? (lang('Direct API') || 'Direct API')
                    : (lang('Proxy') || 'Proxy')}
                </span>
              </div>
              <i className={buildClassName(styles.iconChevronRight, 'icon-chevron-right')} aria-hidden />
