...
const APP_STATES_WITH_BOTTOM_BAR = new Set([
  AppState.Main, AppState.Agent, AppState.Settings, AppState.Explore, AppState.Market, AppState.TokenInfo, AppState.BrotherhoodFi, AppState.PersonalJetton, AppState.CityNetwork,
]);
...
export default memo(withGlobal((global): StateProps => {
  return {
    ...
    isCityNetworkOpen: global.isCityNetworkOpen,
...
function resolveRenderingKey({
  ...
  if (isCityNetworkOpen && isPortrait) return AppState.CityNetwork;
  ...
  if (isMarketOpen && isPortrait && IS_MARKET_ENABLED) {
    return currentTokenSlug && currentTokenSlug === marketTokenSlug ? AppState.TokenInfo : AppState.Market;
  }
  if (isPortfolioOpen && isPortrait && IS_PORTFOLIO_ENABLED) return AppState.Portfolio;
