...
import { IS_GRAM_WALLET, IS_PORTFOLIO_ENABLED } from '../../../../config';
import {
...
function Card({
  ...
  useEffect(() => {
    if (IS_PORTFOLIO_ENABLED && portfolioActiveRange && !isPortfolioOpen) {
      loadPortfolioPnlChange();
    }
        ...
        {primaryValue !== '0' && (
          ...
          >
            <div
              ...
              role={IS_PORTFOLIO_ENABLED ? 'button' : undefined}
              tabIndex={IS_PORTFOLIO_ENABLED ? 0 : undefined}
              onClick={IS_PORTFOLIO_ENABLED ? () => switchToPortfolio() : undefined}
            >
