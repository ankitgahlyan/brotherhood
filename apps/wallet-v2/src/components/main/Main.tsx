...
import { IS_EXPLORE_ENABLED, IS_EXPLORER, IS_MARKET_ENABLED } from '../../config';
import {
...
function Main({
  ...
  useEffectOnce(() => {
    if (IS_EXPLORE_ENABLED) {
      loadExploreSites({ isLandscape, langCode: lang.code });
    }
  });

  useTimeout(loadMarketAssets, IS_MARKET_ENABLED ? MARKET_PRELOAD_DELAY : undefined);
