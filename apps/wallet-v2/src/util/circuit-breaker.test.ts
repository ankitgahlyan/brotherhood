...
describe('bucketKey', () => {
  ...
  it('partitions loopback dev origins (localhost / 127.0.0.1) by path segment automatically', () => {
    expect(bucketKey('http://localhost:1235/toncenter-proxy/api/v3/actions'))
      .toBe('http://localhost:1235/toncenter-proxy');
    expect(bucketKey('http://localhost:1235/api-backend/currency-rates'))
      .toBe('http://localhost:1235/api-backend');
    expect(bucketKey('http://127.0.0.1:1235/tonapiio-proxy/v2/rates'))
      .toBe('http://127.0.0.1:1235/tonapiio-proxy');
    expect(bucketKey('http://localhost:1235/'))
      .toBe('http://localhost:1235');
  });
