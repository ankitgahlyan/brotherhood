...
export function bucketKey(
  ...
  const isLoopbackDevHost = urlObject.hostname === 'localhost' || urlObject.hostname === '127.0.0.1';
  if (!options.includePathPrefix && !isLoopbackDevHost) return urlObject.origin;
