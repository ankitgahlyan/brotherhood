...
import { IS_GRAM_WALLET, NO_EXTRA_FEATURES } from '../../config';
...
export function initPolling(_onUpdate: OnApiUpdate) {
  ...
  void Promise.allSettled([
    ...
    tryUpdateTokens(),
    !IS_GRAM_WALLET && tryUpdateCurrencyRates(),
    !NO_EXTRA_FEATURES && tryUpdateSwapTokens(),
    !NO_EXTRA_FEATURES && !IS_GRAM_WALLET && requireStakingMethods().tryUpdateStakingCommonData(),
