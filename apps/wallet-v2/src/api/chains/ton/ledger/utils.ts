...
// Cast as unknown as any to resolve peer dependency type mismatch between @ledgerhq/hw-transport versions
export const tonTransport = new TonTransport(ledgerTransport as unknown as any);
