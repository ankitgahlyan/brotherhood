      ...
      >
        ...
        <Modal.Body className="space-y-3 text-xs">
          <p className="text-muted-foreground">
            Send the latest wallet bytecode and version from Minter directly to
            any target wallet address. This upgrades the target&apos;s FiWallet
            on-chain without requiring them to trigger it.
          </p>
          <div className="space-y-1.5">
