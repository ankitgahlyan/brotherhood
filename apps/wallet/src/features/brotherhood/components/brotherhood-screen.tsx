              ...
              <div className="space-y-4 bg-card text-card-foreground p-4 border border-border rounded-2xl shadow-sm text-sm">
                <div className="text-center space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    ...
                    days to counter inflation and retain good standing. Failure
                    to pay within 24h grace incurs debt and a 5% penalty.
                  </p>
                </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[11px] text-muted-foreground">
                    ...
                    registered as their on-chain username for peer
                    communication.
                  </p>
                </div>
              ...
              <div className="space-y-3.5 border-t border-border pt-3">
                ...
                <div className="grid grid-cols-2 gap-2 p-1.5 bg-secondary/60 border border-border/80 rounded-2xl">
                  ...
                  >
                    ...
                    <span className="text-[11px] text-muted-foreground mt-1">
                      Reclaim power ({account.data?.votedFor.length ?? 0}{' '}
                      active)
                    </span>
                  </button>
                </div>
                      ...
                      (account.data.votedFor.length > 0 ||
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              setShowVotedDropdown((prev) => !prev)
                            }
                    ...
                    <div className="p-2.5 bg-secondary/80 border border-border rounded-xl space-y-2 mt-1">
                      ...
                      {candidateSourceTab === 'voted' ? (
                        ...
                        <div className="py-4 text-center">
                          <p className="text-xs text-muted-foreground">
                            No Circle members found. Invite members in the
                            Network tab first.
                          </p>
                        </div>
                      ) : (
                        ...
                        onChange={(e) => {
                          ...
                          if (!isNaN(val)) {
                            const maxVal = isUnvote
                              ...
                              : (account.data?.votes ?? 10);
                            setVoteCount(
                              Math.max(1, Math.min(maxVal || 1, val)),
                            );
                          }
                        }}
            ...
            <div className="space-y-4 bg-card text-card-foreground p-4 border border-border rounded-2xl shadow-sm text-sm">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-[11px] text-muted-foreground">
                    Modify any fields below. Changes are batched and applied in
                ...
                <div className="text-[11px] text-muted-foreground space-y-0.5">
                  ...
                  <p>
                    • Changing country requires no active votes cast (must
                    unvote all candidates first).
                  </p>
                </div>
              </div>
            </div>
              ...
              {authoritySubTab === 'status' && (
                <div className="space-y-2 pt-1">
                  ...
                  <input
                    ...
                    value={authStatus}
                    onChange={(e) =>
                      setAuthStatus(parseInt(e.target.value) || 0)
                    }
