                        ...
                        <div className="p-3.5 rounded-xl border border-amber-500/40 bg-amber-500/10 space-y-2.5">
                          ...
                          {!canOperate && (
                            <p className="text-[11px] text-amber-600 dark:text-amber-400">
                              ...
                              suspended. Registration will be enabled once
                              active.
                            </p>
                          )}
                          <Button
                        ...
                        <div className="p-4 rounded-xl border border-dashed border-border bg-secondary/30 flex flex-col items-center text-center space-y-2.5 my-2">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground mt-0.5 max-w-xs">
                              You haven't deployed your personal token yet.
                              Deploy it now to issue credit, establish member
                              trust, and borrow in BrotherHood Network.
                            </p>
                          </div>
                          <Button
                            size="sm"
                  ...
                  <div className="p-4 rounded-xl border border-emerald-500/40 bg-emerald-500/10 space-y-4">
                    ...
                    <div className="p-3 rounded-lg bg-blue-500/10 border border-blue-500/30 text-xs text-blue-700 dark:text-blue-300 space-y-1">
                      ...
                      <p className="text-muted-foreground text-[11px]">
                        ...
                        parameters. Configure its branding and metadata now in
                        the Admin tab.
                      </p>
                    </div>
                    ...
                    <div className="p-3.5 rounded-xl border border-border/70 bg-secondary/30 space-y-3">
                      <div className="flex items-start gap-2">
                        ...
                        <div className="space-y-1 text-xs leading-relaxed text-muted-foreground">
                          ...
                          <p>
                            To guarantee predictable addresses across the
                            network, the contract is deployed initially without
                            metadata. Once deployed, you can customize your
                            token's name, symbol, description, and icon at any
                            time in the{' '}
                  ...
                  {info.hasMismatchedRegistration && (
                    <div className="p-2 bg-amber-500/10 border border-amber-500/20 rounded-lg text-[11px] space-y-1 text-amber-700 dark:text-amber-400">
                      ...
                      <p className="text-muted-foreground">
                        ...
                        instead of current deterministic minter. Register below
                        to link your active token.
                      </p>
                    </div>
                  )}
              ...
              <div className="space-y-4 bg-card text-card-foreground p-4 border border-border rounded-2xl shadow-sm text-sm">
                ...
                {adminSubTab === 'metadata' && (
                  <div className="space-y-3 pt-1">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Update your Personal Token onchain metadata. All fields
                      can be customized.
                    </p>
                    <div className="space-y-2">
                      <div>
            ...
            {activeTab === 'destroy' && (
              <div className="space-y-4 text-sm">
                ...
                <div className="bg-card text-card-foreground p-4 border border-border rounded-2xl shadow-sm space-y-3">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Permanently destroys your Personal Jetton Wallet contract.
                    Any remaining TON balance in the contract will be reclaimed
                    and returned to your connected wallet address. This action
                    is irreversible.
                  </p>
                ...
                {isMinterAdmin ? (
                  <div className="bg-card text-card-foreground p-4 border border-destructive/30 rounded-2xl shadow-sm space-y-3">
                    ...
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      Permanently destroys the Personal Token Minter contract.
                      You are verified as the Minter Admin. Any remaining TON
                      balance in the minter will be returned to your wallet.
                      Once destroyed, this token cannot be minted or recovered.
                    </p>
                  ...
                  <DialogContent className="max-w-md w-[92vw] sm:w-full p-5 gap-4">
                    ...
                    <DialogFooter className="flex-col sm:flex-row gap-2 mt-2">
                      <Button
                        ...
                        disabled={
                          destroyer.isSending || isAuthenticatingDestroy
                        }
                      >
                        Cancel
                      </Button>
                  ...
                  <DialogContent className="max-w-md w-[92vw] sm:w-full p-5 gap-4">
                    <DialogHeader>
                      ...
                      <DialogDescription className="text-xs text-muted-foreground pt-1">
                        ...
                        be refunded to your admin address. This cannot be
                        undone.
                      </DialogDescription>
                    </DialogHeader>
