...
export const NetworkSettingsPanel: React.FC<NetworkSettingsPanelProps> = ({
  ...
  return (
    <div className="flex flex-col gap-4 text-xs">
      ...
      <div className="rounded-2xl bg-secondary/60 p-3.5 border border-border flex flex-col gap-2.5">
        <div className="flex items-center justify-between">
        ...
        <div className="grid grid-cols-2 gap-2 bg-background/70 p-1 rounded-xl border border-border">
          <button
            ...
            className={`flex items-center justify-center gap-2 py-2 px-2 rounded-lg text-xs font-medium transition-all cursor-pointer ${
              routingMode === 'direct'
      ...
      <div className="p-3.5 bg-secondary/60 border border-border rounded-2xl flex flex-col gap-3">
        <div className="flex items-center justify-between">
        ...
        <div className="flex items-center justify-between pt-1">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1 bg-secondary hover:bg-muted border border-border rounded-lg text-xs font-medium transition-colors disabled:opacity-50 cursor-pointer"
          >
      ...
      <div className="flex justify-center">
        <Button
          ...
          className="w-full text-xs font-medium py-2.5 rounded-xl cursor-pointer"
        >
          <RefreshCw
      ...
      <div className="flex items-center justify-between pt-2 border-t border-border/60">
        <button
          ...
          className="flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground transition-colors px-2.5 py-1.5 rounded-lg hover:bg-muted/50 cursor-pointer"
        >
