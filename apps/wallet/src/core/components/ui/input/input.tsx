...
const Title: FC<ComponentProps<'span'>> = ({
  className,
  children,
  ...props
}) => (
...
const Field: FC<ComponentProps<'div'>> = ({
  className,
  children,
  ...props
}) => {
...
const InputControl: FC<ComponentProps<'input'>> = ({
  className,
  ...
  const { inputRef, measureMaxRef, measureMinRef, resizeStyle, adjustSize } =
    useInputResize({
      resizable,
      contextSize: size,
      value: props.value,
...
const Caption: FC<ComponentProps<'span'>> = ({
  className,
  children,
  ...props
}) => {
