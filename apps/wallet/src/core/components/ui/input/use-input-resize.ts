...
/**
 * Scales an input's font size down to fit its width (down to the `s`-size font),
 * mirroring the appkit-react input. Measures the text at the max font via a hidden
 * span and applies the resulting font-size inline.
 */
