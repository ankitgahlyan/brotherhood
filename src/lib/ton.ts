...
export async function getWalletAddress( // todo: calc offchain
  ...
  // const storage: FiWalletStore = FiWalletStore.create({
  //       addresses: {
  ...
  //           votedFor: [],
  //           reportInfo: {
  //             ref: ReportInfo.create({ reports: [] })
  //           },
  //       }},
  //       timestamps: {
  //         ref: TimeStamps.create({})}
  //   });

  //   const calcAddr = AutoDeployAddress {
