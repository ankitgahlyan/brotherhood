...
- Treat `wrappers-ts/FossFi.gen.ts` and `wrappers-ts/FossFiWallet.gen.ts` as generated output. Prefer regenerating them from the contract ABI instead of hand-editing them when the ABI changes.
